...
---
# IAB TCF 2.2 support in Audience Manager {#iab-tcf-support-in-audience-manager}

Adobe provides you with the means to manage and communicate your users' privacy choices through the Opt-in functionality and through the Audience Manager Plug-in to IAB Transparency and Consent Framework 2.2 (TCF 2.2) support. This article works together with the documentation to help you understand the Audience Manager Plug-in to IAB TCF and how it works together with Adobe's Opt-in object and your Consent Management Provider (CMP). To learn more about the IAB, please see their Web site at [https://www.iabeurope.eu/](https://www.iabeurope.eu/).

## First step: Understand the Experience Cloud ID opt-in {#first-step-understand-ecid-s-opt-in}
...
## Enable IAB TCF {#enabling-iab-tcf}
...
With IAB TCF 2.2, there are ten "purposes" for which to gather consent (what vendors can do with the visitor's data). Adobe Audience Manager does not require all ten, but rather only requires consent for the following purposes, in addition to vendor consent:
...
## Opt-in: Translating between IAB and Adobe applications {#opt-in-translating-between-iab-and-adobe-solutions}
...
For more detailed information about the Audience Manager Plug-In for IAB TCF 2.2, including how to implement and test, use cases, and workflow, please see the [documentation](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/consent-management/aam-iab-plugin.html).
